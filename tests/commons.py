...
class InvoiceContentTestCase(TestCase):
    def setUp(self):
        self.invoice_json: str = '{"naturapeuteID":"000000000000000000000000","author":{"name":"Cabinet de Leroy","street":"Via delle Vigne 1","ZIP":"7149","city":"Vrin","email":"LeroyFrechette@armyspy.com","phone":"081 660 68 36","RCC":"V123123"},"therapist":{"firstName":"Leroy","lastName":"Fréchette","street":"Via delle Vigne 1","ZIP":"7149","city":"Vrin","phone":"081 660 68 36","RCC":"V123123"},"patient":{"firstName":"Nicholas","lastName":"Ailleboust","street":"Tösstalstrasse 97","ZIP":"8872","city":"Weesen","canton":"SG","birthday":-1118102400,"gender":"female","email":"NicholasAilleboust@teleworm.us"},"servicePrice":100,"services":[{"date":1584921600000,"code":1003,"duration":60},{"date":1585008000000,"code":1004,"duration":30}],"timestamp":1585049118.485}'
...
class InvoiceContentInvalidTestCase(TestCase):
    ...
    def setUp(self):
        self.invoice_invalid_json: str = '{"naturapeuteID":"000000000000000000000000","author":{"street":"Via delle Vigne 1","ZIP":"7149 7149 7149 7149","city":"Vrin","email":"LeroyFrechette@armyspy.com","phone":"081 660 68 36","RCC":"V12312"},"therapist":{"firstName":"Leroy","lastName":"Fréchette","street":"Via delle Vigne 1","ZIP":"7149","city":"Vrin","phone":"081 660 68 36","RCC":"V123123"},"patient":{"firstName":"Nicholas","lastName":"Ailleboust","street":"Tösstalstrasse 97","ZIP":"8872","city":"Weesen","canton":"SG","birthday":-1118102400,"gender":"female","email":"NicholasAilleboust@teleworm."},"servicePrice":100,"services":[{"date":1584921600000,"code":1003,"duration":60},{"date":1585008000000,"code":1004,"duration":30}],"timestamp":1585049118.485}'
...
class InvoiceContentImproperJSONTestCase(TestCase):
    FAILURE_JSON = '[\n  {\n    "loc": [\n      "__root__"\n    ],\n    "msg": "Expecting property name enclosed in double quotes: line 1 column 2 (char 1)",\n    "type": "value_error.jsondecode",\n    "ctx": {\n      "msg": "Expecting property name enclosed in double quotes",\n      "doc": "{naturapeuteID:\\"000000000000000000000000\\"}",\n      "pos": 1,\n      "lineno": 1,\n      "colno": 2\n    }\n  }\n]'
